          ...
          >
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="relative">
                ...
                {showThemeDropdown && (
                  <div className="absolute top-full right-0 mt-2 w-32 bg-black/90 backdrop-blur-xl border border-white/20 rounded-xl overflow-hidden z-[9999] shadow-2xl">
                    <button
                      onClick={() => {
                        setTheme('light');
              ...
              <div className="relative">
                ...
                {showVersionDropdown && (
                  <div className="absolute top-full right-0 mt-2 w-64 bg-black/90 backdrop-blur-xl border border-white/20 rounded-xl overflow-hidden z-[9999] shadow-2xl">
                    {aiModels.map((model) => (
                      <button
                        key={model.id}
                        onClick={() => {
