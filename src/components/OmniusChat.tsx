            ...
            <button
              ...
              className={`w-full text-left px-4 py-4 transition-all duration-300 border-l-2 ${
                selectedVersion === model.name 
                  ? 'bg-blue-600/20 text-white border-blue-400 shadow-lg shadow-blue-500/20' 
                  : 'text-white/70 hover:bg-white/5 hover:text-white/90 border-transparent hover:border-white/30'
              }`}
            >
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500/20 to-blue-600/20 flex items-center justify-center border border-blue-400/30">
