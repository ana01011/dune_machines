      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center space-x-2 mb-2 sm:mb-3">
          <button
            ...
            className={`px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg text-xs font-light transition-all duration-300 ${
              inputMode === 'text' 
          ...
          <button
            ...
            className={`px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg text-xs font-light transition-all duration-300 flex items-center space-x-1 sm:space-x-2 ${
              inputMode === 'code' 
          ...
          <div className="flex items-end space-x-2 sm:space-x-4">
            ...
            <div className="flex-1 relative">
              <textarea
                ...
                className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 pr-10 sm:pr-12 rounded-2xl resize-none transition-all duration-300 font-light text-sm sm:text-base ${
                  inputMode === 'code' 
              ...
              {/* Character Count */}
              <div className="absolute bottom-2 right-8 sm:right-12 text-xs text-white/50">
                {message.length}
              </div>
            </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <button 
                ...
                className="p-2 sm:p-3 rounded-xl text-white/70 hover:text-white hover:bg-white/10 transition-all duration-300"
              >
