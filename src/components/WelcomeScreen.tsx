    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
        ...
        {showAISelection && (
          <div 
            ref={dropdownRef}
            className="mt-4 w-full max-w-sm sm:max-w-md px-4"
          >
            <div 
              className="backdrop-blur-2xl border border-blue-400/30 rounded-xl overflow-hidden shadow-2xl max-h-80 overflow-y-auto"
              style={{
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="text-right flex-shrink-0">
                        ...
                        <div className="w-8 h-1 bg-white/10 rounded-full overflow-hidden mt-1">
                          <div 
