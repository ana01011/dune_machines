    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
        ...
        {showAISelection && (
          <div 
            ref={dropdownRef}
            className="mt-4 w-full max-w-xs sm:max-w-sm px-4 md:max-h-56"
          >
            <div 
              className="backdrop-blur-2xl border border-blue-400/30 rounded-xl overflow-hidden shadow-2xl max-h-64 md:max-h-48 overflow-y-auto custom-ai-scrollbar"
              style={{
