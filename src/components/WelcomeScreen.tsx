    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
        ...
        {showAISelection && (
          ...
          >
            <div 
              className="backdrop-blur-2xl border border-blue-400/30 rounded-2xl overflow-hidden shadow-2xl"
              style={{
              ...
              {aiModels.map((ai) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left px-6 py-4 transition-all duration-300 hover:bg-blue-500/10 border-b border-white/5 last:border-b-0 ${
                      isSelected
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          <div className="text-sm font-light text-white tracking-wider">{ai.name}</div>
                          <div className="text-xs text-white/60 font-light">{ai.subtitle}</div>
                        </div>
                        <div className="text-right">
                          <div className="text-xs text-blue-400/80">{ai.powerLevel}%</div>
